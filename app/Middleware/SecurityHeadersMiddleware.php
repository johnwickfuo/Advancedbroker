...
final class SecurityHeadersMiddleware {
    public function handle(Request $request,callable $next):Response{
        ...
        $headers=[
            ...
            'Content-Security-Policy'=>"default-src 'self'; base-uri 'self'; form-action 'self'; frame-ancestors 'none'; object-src 'none'; img-src 'self' data: https://unsplash.com https://images.unsplash.com; font-src 'self' data:; style-src 'self' 'nonce-".$nonce."'; script-src 'self'; connect-src 'self'"
        ];
