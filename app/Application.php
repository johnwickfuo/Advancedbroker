...
final class Application {
    public static function boot(string $basePath): Router {
        ...
        $config = ['app'=>require $basePath.'/config/app.php','database'=>require $basePath.'/config/database.php','mail'=>require $basePath.'/config/mail.php','security'=>require $basePath.'/config/security.php','geoip'=>require $basePath.'/config/geoip.php','localization'=>require $basePath.'/config/localization.php','google_translation'=>require $basePath.'/config/google_translation.php','ai_trading'=>require $basePath.'/config/ai_trading.php'];
        date_default_timezone_set($config['app']['timezone']);
        $container = Container::instance();
        $container->set('config',$config); $container->set('logger',new Logger($basePath.'/storage/logs')); $container->set('cache',new Cache($basePath.'/storage/cache')); $container->set('page_translation',new GooglePageTranslationService($config['google_translation'],$container->get('cache'),$container->get('logger'))); $container->set('csrf',new Csrf()); $container->set('view',new View($basePath.'/resources/views')); $container->set('upload',new UploadService($basePath.'/storage/uploads/public',$basePath.'/storage/private',$config['app']['uploads']['max_bytes']));
        $database = null;
