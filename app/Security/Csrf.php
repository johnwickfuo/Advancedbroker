...
final class Csrf {
    public function token():string{if(empty($_SESSION['_csrf_token']))$_SESSION['_csrf_token']=bin2hex(random_bytes(32));return(string)$_SESSION['_csrf_token'];}
    ...
    public function verify(?string $token):bool{return $this->valid($token);}
