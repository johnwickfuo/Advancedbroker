...
try {
    ...
    (new \Database\Seeds\DepositMethodSeeder())->run($db);
    (new \Database\Seeds\MinimalKycSeeder())->run($db);
    (new \Database\Seeds\WithdrawalFormSeeder())->run($db);
    (new \Database\Seeds\QaUserSeeder())->run($db);
    echo "Seeded countries, languages, authentication settings, company records, AI trading categories, legal pages, FAQs, deposit methods, universal minimal KYC, global withdrawal configuration and optional QA user.\n";
} catch (Throwable $e) {
