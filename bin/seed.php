...
try {
    ...
    echo "Seeded countries, languages, authentication settings, company records, AI trading categories, legal pages, FAQs, deposit methods, global withdrawal configuration and optional QA user.\n";
} catch (Throwable $e) {
